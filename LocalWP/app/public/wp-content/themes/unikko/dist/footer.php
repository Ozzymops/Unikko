			...
			<div class="col-md-12">
				...
				<footer class="site-footer" id="colophon">
					...
					<div class="footer-nav">
						...
						<p><a style="display: none;" class="hover-text" href="">Klachtencommissie</a></p>
					</div>
					...
					<div class="footer-contact">
						...
						<p style="font-style: italic;">© Copyright 2026 Unikko | Alle rechten voorbehouden</p>
						<div class="footer-credits">
							<p>Thema en achterliggende code<br>© Justin Muris @ <a href="https://github.com/Ozzymops">Ozzymops</a></p>
							<div style="max-width: 25px; width: 100%;"></div>
							<p>Beeld en grafische vormgeving<br>© Rory Snel @ <a href="https://sites.google.com/view/rorysnel">rorysnel</a></p>
						</div>
					</div>

					<div class="footer-art">
						<img src="<?php echo get_stylesheet_directory_uri(); ?>/img/art-flowers-1.png" />	
					</div>
